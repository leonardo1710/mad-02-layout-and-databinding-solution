...
class MainActivity : AppCompatActivity() {
    ...
    private fun createMovieObject(): Movie{
        var movie = Movie("The Queen's Gambit", moveDescription)
